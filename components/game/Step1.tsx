    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        <div className="p-4 border rounded-lg bg-muted/50">
          <h4 className="font-semibold mb-2">Degree: B.S. in Computer Science</h4>
          <p className="text-sm text-muted-foreground">You have two remaining requirements to fulfill: Two mandatory Computer Science electives.</p>
        </div>
